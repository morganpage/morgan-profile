...
const icons = {
  triangle: {
    shape: <polygon filter="url(#blurMe)" strokeWidth="1px" strokeLinejoin="round" strokeMiterlimit="10" points="14.921,2.27 28.667,25.5 1.175,25.5 " />,
    viewBox: `0 0 30 30`,
  },
  circle: {
  ...
  arrowUp: {
    shape: (
      <React.Fragment>
        <path filter="url(#blurMe)" d="M28.74,20.81H1.26a1.26,1.26,0,0,1-1-2L14.16.5a1.25,1.25,0,0,1,1-.5h0a1.24,1.24,0,0,1,1,.51L29.75,18.8a1.25,1.25,0,0,1-1,2ZM3.81,18.29H26.22L15.16,3.37Z" />
        {` `}
        <path filter="url(#blurMe)" d="M28.74,42H1.26a1.28,1.28,0,0,1-1.13-.71A1.26,1.26,0,0,1,.26,40l13.9-18.29a1.28,1.28,0,0,1,1-.5h0a1.24,1.24,0,0,1,1,.51L29.75,40a1.26,1.26,0,0,1,.12,1.32A1.28,1.28,0,0,1,28.74,42ZM3.81,39.47H26.22L15.16,24.55Z" />
      </React.Fragment>
    ),
    viewBox: `0 0 30 42`,
  },
  ...
  hexa: {
    shape: (
      <polygon filter="url(#blurMe)"  strokeLinejoin="round" strokeMiterlimit="10" points="27.5,21.904 15,28.809  2.5,21.904 2.5,8.095 15,1.19 27.5,8.095 " />
    ),
    viewBox: `0 0 30 30`,
  },
  cross: {
    shape: (
      <path filter="url(#blurMeLots)"
        strokeWidth="3px"
